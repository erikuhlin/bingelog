...
function ProviderItem({ p }: { p: WatchProvider }) {
  ...
  return (
    <div
      ...
      className="group flex items-center gap-2 px-3 py-1.5 rounded-xl bg-zinc-800/80 border border-zinc-700/80 hover:border-zinc-500 transition-all shadow-sm"
    >
      {imgErr || !p.logo_path ? (
        <div className="w-6 h-6 rounded-lg bg-zinc-700 text-white font-bold text-xs flex items-center justify-center">
