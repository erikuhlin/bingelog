          ...
          <button
            ...
            className={`flex items-center gap-2.5 px-3.5 py-2 rounded-2xl text-xs font-bold whitespace-nowrap transition-all flex-shrink-0 border ${
              isSelected
                ...
                : 'bg-zinc-900/90 text-zinc-300 border-zinc-800 hover:border-zinc-700 hover:bg-zinc-850'
            }`}
          >
            <div className="w-5 h-5 rounded-md overflow-hidden bg-zinc-950 flex-shrink-0 flex items-center justify-center">
              <img
